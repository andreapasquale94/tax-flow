...
TEST( Zonotope, FewerLeavesThanBoundingBox )
{
    ...
    auto zono_tree = tax::ads::propagate< P >( tax::ode::methods::Verner89{}, crit, rhs(), z,
                                               center, 0.0, t1, cfg );
    auto box_tree = tax::ads::propagate< P >( tax::ode::methods::Verner89{}, crit, rhs(), bb,
                                              center, 0.0, t1, cfg );
...
TEST( Zonotope, SplitThenMergeRoundTrip )
{
    ...
    auto tree = tax::ads::propagate< P >( tax::ode::methods::Verner89{},
                                          TruncationCriterion{ /*tol=*/1e-5, /*maxDepth=*/8 },
                                          rhs(), z, center, 0.0, t1, cfg );
