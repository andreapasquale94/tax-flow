...
int main()
{
    ...
    const auto& probe_map = probe.leaf( probe.done().front() ).payload;
    ...
    auto leafCounts = [&]( auto domain ) {
        ...
        for ( double t : example::linspace( 0.0, t_final, kNSnaps ) )
        {
            ...
            auto tree = tax::ads::propagate< P >( Verner89{}, criterion, rhs(), domain, icCenter(),
    ...
    {
        auto tree = tax::ads::propagate< P >( Verner89{}, criterion, rhs(), cover_aligned,
