...
int main()
{
    ...
    for ( double t : example::linspace( 0.0, t_final, kNSnaps ) )
    {
        ...
        {
            auto zsol = tax::ads::propagate< P >( Verner89{}, criterion, rhs(), ic_zono, icCenter(),
                                                  0.0, t, cfg, adsThreads() );
            const auto& ztree = zsol.tree();
            int id = 0;
            ...
            auto bsol = tax::ads::propagate< P >( Verner89{}, criterion, rhs(), ic_box, icCenter(),
                                                  0.0, t, cfg, adsThreads() );
            const auto& btree = bsol.tree();
            id = 0;
